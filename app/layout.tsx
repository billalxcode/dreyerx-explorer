...
export const metadata: Metadata = {
    ...
    icons: {
        apple: 'https://scan.dreyerx.com/assets/apple-touch-icon.png',
        icon: 'https://scan.dreyerx.com/assets/favicon.ico',
    },
    robots: 'index, follow',
    openGraph: {
        title: 'DreyerX Explorer',
        ...
        images: [
            {
                url: 'https://scan.dreyerx.com/assets/og-image.png',
                width: 1920,
                height: 1080,
    ...
    twitter: {
        ...
        description:
            'Explore the world of DreyerX with our comprehensive explorer.',
        images: ['https://scan.dreyerx.com/assets/og-image.png'],
    },
};
